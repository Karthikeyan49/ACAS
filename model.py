"""
model.py — LightGBM training, Optuna hyperparameter tuning, and model persistence.

Features:
  - Regression (risk score) and Classification (high-risk alert)
  - Optuna Bayesian hyperparameter search
  - Early stopping with validation set
  - K-fold cross-validation
  - Model saving / loading
  - Threshold optimisation for classifier
"""
