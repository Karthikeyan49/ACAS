#!/usr/bin/env python3
# =============================================================================
# satellite_process.py — Power House Satellite Orbital Simulator
#
# PURPOSE:
#   Continuously updates satellite_model.json with realistic orbital data.
#   Simulates ALL the things that change on a real satellite in LEO:
#     • Position/velocity via Keplerian + J2 perturbation + drag
#     • Battery charge/discharge (sunlight vs eclipse cycle)
#     • Fuel drain (slow continuous + burn events)
#     • Temperature cycling (orbital thermal environment)
#     • ADCS (reaction wheels, pointing, angular rate)
#     • Communications (ground contact windows, Doppler shift)
#     • Environmental parameters (drag, radiation, solar flux)
#
# HOW TO RUN:
#   python satellite_process.py
#   (keep this running in a separate terminal alongside app.py)
#
# PHYSICS:
#   • GM = 398600.4418 km³/s²
#   • J2 perturbation: RAAN drift ~-6.5°/day for 550km SSO
#   • Atmospheric drag: altitude decays ~2m/day at 550km
#   • Eclipse detection: cylindrical shadow model
#   • Temperature: radiative balance with solar input + Earth albedo
#
# DATA UPDATE RATE: 0.5 seconds (real time)
# SIMULATION TIME RATIO: configurable (default 100× — 1 real minute = ~1.7 orbits)
# =============================================================================
...
MODEL_FILE   = os.path.join(SCRIPT_DIR, "satellite_model.json")
